  ...
  return (
    <main>
      ...
      <article className="case-study" id="case-4">
        ...
        <div className="case-body">
          <Section label="The Setup"><p>I helped open XHIBITION in 2014 and managed the store. Fairly quickly I got pulled behind the scenes into operations — less by plan than by being the person who kept solving whatever was broken. The scope never stopped widening. By the end there were three brands, XHIBITION, Rule of Next, and two:minds, each with its own identity and customer, none with a dedicated team, and I was the only person working across all three.</p></Section>
          <Section label="What That Actually Meant"><p>Shopify Plus backend, site speed, SEO, and blog content. Product and lifestyle photography workflow, with the fastest turnaround on the team. Visual merchandising and category hierarchy for promotional events. Homepage creative and campaign graphics. Visual identity and packaging held as a system across all three brands rather than rebuilt per project. Off-site shoot production from concept through execution, on budget — the resulting creative consistently outperformed everything else we ran. Our Klaviyo rep once told me she didn’t believe one person was doing all of it.</p></Section>
